...
- **Main CSS** (`css/style.css`, ~117 KB) — Complete styling with animations
...
- **JavaScript** (`js/app.js` + `js/main.js`, ~54 KB each, must be identical) — Full interactivity, zero dependencies
- **Hero Slideshow** — 12 images, manual navigation, swipe/touch
...
- Localized SEO keywords targeting Shamli, physiotherapy, chiropractic, doctor names
...
1. **Already deployed** on Netlify via GitHub auto-deploy
2. **Domain** `shamliphysiotherapy.com` connected via Hostinger
3. **Google Search Console** verified with sitemap submitted
4. **Google Business Profile** claimed and linked
5. **Email notifications** configured for form submissions

**→ See DEPLOYMENT-CHECKLIST.md for complete launch record**
...
| Item | Cost |
|------|------|
| Domain (shamliphysiotherapy.com) | ₹800–1,200/year |
...
**Appointment Email:** physiotherapyshamli@gmail.com
...
### Performance (PageSpeed Insights — June 2026)
✓ Desktop: 77–90 Performance | 100 Accessibility | 100 Best Practices | 100 SEO
✓ Mobile: 69–78 Performance | 100 Accessibility | 100 Best Practices | 100 SEO
...
✓ Live at https://shamliphysiotherapy.com
...
### Annually
- Renew domain at Hostinger / GoDaddy
