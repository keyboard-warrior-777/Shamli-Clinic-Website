...
Your website is **live** at [shamliphysiotherapy.com](https://shamliphysiotherapy.com) — deployed on Netlify via GitHub auto-deploy. All steps below have been completed.
...
- [x] Localized SEO keywords (Shamli, physiotherapy, chiropractic, doctor names)
...
- [x] 404 error page
- [x] Accessibility (ARIA attributes, skip links, keyboard navigation, WCAG contrast)
...
### Buy from Hostinger or GoDaddy

1. Go to **https://www.hostinger.in** or **https://www.godaddy.com**
2. Search for `shamliphysiotherapy.com`
3. Add to cart:
   - Make sure **1 Year** registration is selected.
   - De-select any pre-ticked **Web Hosting**, **Website Builder**, or **Professional Email** packages.
   - Choose the default free **WHOIS Privacy Protection** (don't pay for Full/Ultimate Domain Protection).
4. Create account → Pay (approx. ₹800–1,200/year for 1 year including tax)
...
4. Log in to your domain registrar (**Hostinger** or **GoDaddy**) and go to **Domain Management**
5. Change **Nameservers** to **Custom Nameservers** and paste all 4 Netlify nameservers
...
4. Enter: `physiotherapyshamli@gmail.com`
...
2. Enter `shamliphysiotherapy.com`
3. Verify using DNS (add TXT record in your registrar or Netlify DNS)
...
| Item | Cost |
|------|------|
| Domain (Hostinger/GoDaddy, 1 year) | ₹800–1,200 |
